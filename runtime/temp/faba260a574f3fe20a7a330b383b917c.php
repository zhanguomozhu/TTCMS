            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($flinks) || $flinks instanceof \think\Collection || $flinks instanceof \think\Paginator): $i = 0; $__LIST__ = $flinks;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" style="width: 30%;"><?php echo $vo['url']; ?></td>
                                <td align="center" style="width: 10%;">
