<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\ad\lst.html";i:1517885249;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516609361;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>广告位列表</title>
...
<button type="button" tooltip="添加广告位" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"> <i class="fa fa-plus"></i> 添加
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($ads) || $ads instanceof \think\Collection || $ads instanceof \think\Paginator): $i = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" style="width: 30%;"><?php echo $vo['name']; ?></td>
                                <td align="center" style="width: 10%;"><?php echo $vo['type']; ?></td> 
                                <td align="center" style="width: 20%;"><?php if($vo['category_id'] == 0): ?>全站通用<?php else: ?><?php echo $vo['category']['name']; endif; ?></td>
