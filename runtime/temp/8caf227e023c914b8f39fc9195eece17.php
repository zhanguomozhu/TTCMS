<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\conf_cate\edit.html";i:1515647406;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1515826148;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>编辑配置分类</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑配置分类</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="enname"  type="text" value="<?php echo $cates['enname']; ?>">
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cnname"  type="text"  value="<?php echo $cates['cnname']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
