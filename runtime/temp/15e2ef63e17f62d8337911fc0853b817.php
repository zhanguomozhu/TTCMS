<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\featured\lst.html";i:1517882260;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516609361;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>推荐位列表</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="<?php echo url('lst'); ?>">推荐位列表</a>
                        </li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
...
<button type="button" tooltip="添加推荐位" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"> <i class="fa fa-plus"></i> 添加
</button>
<div class="row">
