<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\category\edit.html";i:1516857922;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516609361;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>编辑栏目</title>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="jiben" class="tab-pane active">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name='model_id' onchange="setTemplate(this)">
                                                    ...
                                                    <option value="<?php echo $vo['id']; ?>" <?php if($model['model_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                                            ...
                                            <div class="col-sm-6">
                                                <select name='pid'>
                                                    <option value="0">一级栏目</option>
                                                        <?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!in_array($vo['id'],$sons)): ?>
                                                                <option value="<?php echo $vo['id']; ?>" <?php if($model['pid'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="请输入栏目名称" name="name"  type="text" value="<?php echo $model['name']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <?php echo uploadImg(['image_url',$model['image_url']],$model['image_url']); ?>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="6" name="description" placeholder="请输入栏目描述" ><?php echo $model['description']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label no-padding-right">排序</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" name="sort"  type="text" value="<?php echo $model['sort']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label style="margin-top:5px; ">
                                                    <input class="checkbox-slider toggle colored-blue" type="checkbox" name="is_menu" <?php if($model['is_menu'] == 1): ?>checked<?php endif; ?> value="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label style="margin-top:5px; ">
                                                    <input class="checkbox-slider toggle colored-blue" type="checkbox" name="is_cover" <?php if($model['is_cover'] == 1): ?>checked<?php endif; ?> value="1">
                                                    <span class="text"></span>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                ...
                                <div id="moban" class="tab-pane">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="请输入封面页模版" name="index_template"  type="text" value="<?php echo $model['index_template']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="请输入列表页模版" name="list_template"  type="text" value="<?php echo $model['list_template']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="请输入详情页模版" name="show_template"  type="text" value="<?php echo $model['show_template']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div id="seo" class="tab-pane">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="请输入栏目页面关键词,关键字中间用半角逗号隔开" name="meta_keywords"  type="text" value="<?php echo $model['meta_keywords']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea class="form-control" rows="6" placeholder="请输入栏目页面描述,针对搜索引擎设置的网页描述" name="meta_description"><?php echo $model['meta_description']; ?></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
