                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label no-padding-right">推荐位名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="name" type="text" value="<?php echo $featured['name']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="category_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($featured['category_id'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="sort"  type="text" value="<?php echo $featured['sort']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
