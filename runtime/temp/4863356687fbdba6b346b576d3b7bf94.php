<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\article\edit.html";i:1517900190;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516609361;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>编辑文章</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               <select name="category_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($article['category_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="title" required="" type="text" value="<?php echo $article['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <?php echo uploadImg(['image_url',$article['image_url']],$article['image_url']); ?>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-top:5px; ">
                                    <input class="checkbox-slider toggle colored-blue" type="checkbox" <?php if($article['is_recommend'] == 1): ?>checked<?php endif; ?> name="is_recommend" value="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-top:5px; ">
                                    <input class="checkbox-slider toggle colored-blue" type="checkbox" <?php if($article['is_top'] == 1): ?>checked<?php endif; ?> name="is_top" value="1">
                                    <span class="text"></span>
                                </label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="keywords" required="" type="text" value="<?php echo $article['keywords']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea  class="form-control" rows="6" name="description" placeholder=""><?php echo $article['description']; ?></textarea>
                            </div>
                    ...
                    <script>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control" id="create_time" placeholder="" value="<?php echo $article['create_time']; ?>" name="create_time" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="clicks" required="" type="text" value="<?php echo $article['clicks']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="url" required="" type="text" value="<?php echo $article['url']; ?>">
                            </div>
