<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\conf\conf.html";i:1516600383;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516609361;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>系统配置</title>
                    ...
                    <div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="<?php if($key == 0): ?>active<?php endif; ?>">
                                <a data-toggle="tab" href="#<?php echo $vo['enname']; ?>">
                                    <?php echo $vo['cnname']; ?>
                                </a>
                            </li>
                        ...
                        <div class="tab-content">
                            <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <div id="<?php echo $vo['enname']; ?>" class="tab-pane <?php if($key == 0): ?>active<?php endif; ?>">
                                <form action="" method="post">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($vo['confs']) || $vo['confs'] instanceof \think\Collection || $vo['confs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['confs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                            <tr>
                                                <td align="center" style="width: 20%;"><?php echo $v['cnname']; ?></td>
                                                <td align="left" style="width: 80%;">
                                                <?php echo formStyle($v['type'],$v); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?> 
                                          <tr >
