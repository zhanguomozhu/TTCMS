                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label no-padding-right">广告位</label>
                            <div class="col-sm-6">
                               <select name="ads_id">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($banner['ad_id'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label no-padding-right">广告图片</label>
                            <div class="col-sm-6">
                                <?php echo uploadImg(['img_url',$banner['img_url']],$banner['img_url']); ?>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="title" type="text" value="<?php echo $banner['title']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-1 control-label no-padding-right">简介</label>
                            <div class="col-sm-6">
                                <textarea  class="form-control" rows="6" name="description"><?php echo $banner['description']; ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="jump_url" type="text" value="<?php echo $banner['jump_url']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="sort" type="text" value="50" value="<?php echo $banner['sort']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label style="margin-top:5px; ">
                                    <input class="checkbox-slider toggle colored-blue" type="checkbox" <?php if($banner['status'] == 1): ?>checked<?php endif; ?> name="status" value="1">
