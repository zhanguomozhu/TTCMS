...
<button type="button" tooltip="添加" class="btn btn-sm btn-azure btn-addon" onClick="dialog.toconfirm('确实要备份吗','<?php echo url('backup'); ?>')"> <i class="fa fa-plus"></i> 添加备份
</button>
<div class="row">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" style="width: 20%;">
                                    <a onClick="dialog.confirm('确实要下载吗','<?php echo url('dowonload',array('name'=>$vo['name']),''); ?>')" class="btn btn-success btn-sm shiny">
                                        <i class="fa fa-edit"></i> 下载
                                    </a>
                                    <a onClick="dialog.toconfirm('确实要还原吗','<?php echo url('restore',array('name'=>$vo['name']),''); ?>')" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 还原
                                    </a>
                                    <a onClick="dialog.toconfirm('确实要删除吗','<?php echo url('del',array('name'=>$vo['name']),''); ?>')" class="btn btn-danger btn-sm shiny">
