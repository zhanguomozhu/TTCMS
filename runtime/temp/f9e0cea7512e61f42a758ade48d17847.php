<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\conf\edit.html";i:1516599476;s:70:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\top.html";i:1516593725;s:71:"D:\phpStudy\WWW\TLCMS\public/../application/admin\view\public\left.html";i:1515654260;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>编辑配置</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name='conf_cate_id'>
                                    <option value="0">请选择</option>
                                    <?php if(is_array($cates) || $cates instanceof \think\Collection || $cates instanceof \think\Paginator): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $vo['id']; ?>" <?php if($conf['conf_cate_id'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['cnname']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="enname"  type="text" value="<?php echo $conf['enname']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="cnname"  type="text" value="<?php echo $conf['cnname']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name='type'>
                                    <option value="0">请选择</option>
                                    <option value="1" <?php if($conf['type'] == 1): ?>selected="selected"<?php endif; ?>>单行文本</option>
                                    <option value="2" <?php if($conf['type'] == 2): ?>selected="selected"<?php endif; ?>>多行文本</option>
                                    <option value="3" <?php if($conf['type'] == 3): ?>selected="selected"<?php endif; ?>>单选按钮</option>
                                    <option value="4" <?php if($conf['type'] == 4): ?>selected="selected"<?php endif; ?>>复选按钮</option>
                                    <option value="5" <?php if($conf['type'] == 5): ?>selected="selected"<?php endif; ?>>下拉菜单</option>
                                    <option value="6" <?php if($conf['type'] == 6): ?>selected="selected"<?php endif; ?>>上传按钮</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="values"><?php echo $conf['values']; ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
