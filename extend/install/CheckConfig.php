...
{
    //安装需求
    private $php_version     = '5.4.0';                                             //php版本
    private $must_extension  = array('gd','xml','session','iconv','bcmath','gd');   //php扩展
    private $recom_extension = array('zip','curl');                                 //php扩展
    private $writeable_dir   = array('runtime','public/uploads');                          //php版本
    //php扩展
    private $php_ini         = array(
            'safe_mode'         => array('type' => '=','value' => false),
            'allow_url_fopen'   => array('type' => '=','value' => '1'),
            'memory_limit'      => array('type' => '>','value' => '12M'),
        );
    //php函数
