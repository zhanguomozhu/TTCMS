...
REPLACE INTO `tp_auth_group` (`id`, `title`, `status`, `rules`, `create_time`,`update_time`) VALUES
(1,'超级管理员',1,'',1509167505,1509167505),
(2,'普通管理员',1,'',1509167505,1509167505);
...
REPLACE INTO `tp_auth_group_access` (`admin_id`, `group_id`, `create_time`,`update_time`) VALUES
(1,1,1509167505,1509167505);



--
-- 转存表中的数据 `tp_conf_cate`
--

REPLACE INTO `tp_conf_cate` (`enname`, `cnname`,`sort` ,`status` ,`create_time`,`update_time`) VALUES
('site','站点配置',1,1,1509167505,1509167505),
('seo','SEO配置',2,1,1509167505,1509167505),
('station_master','站长配置',3,1,1509167505,1509167505);
...
REPLACE INTO `tp_category` (`id`, `parent_id`, `model_id`, `name`, `image_url`, `description`, `is_menu`, `sort`, `meta_keywords`, `meta_description`, `index_template`, `list_template`, `show_template`, `url`, `is_cover`) VALUES
...
REPLACE INTO `tp_download` (`id`, `category_id`, `title`, `image_url`, `file_url`, `filename`, `is_recommend`, `is_top`, `description`, `create_time`, `hits`, `download_num`, `url`, `demo_url`) VALUES
...
(5, 13, '老张博客前台模版分享', '/uploads/images/20170625/a31d5a1b828b98505101cf6e73d2106a.png', 'https://pan.baidu.com/s/1hsaC8p2', '', 0, 0, '老张博客前台模版分享,用的layui搭建的简洁大方的前台模版，简单易用，方便！', '2017-02-24 14:22:04', 1027, 0, '/index/download/show/id/5.html', 'http://www.phpdefault.com'),
...
REPLACE INTO `tp_model` (`id`, `name`, `tablename`, `index_template`, `list_template`, `show_template`) VALUES
...
REPLACE INTO `tp_page` (`id`, `category_id`, `title`, `description`, `content`, `image_url`, `create_time`) VALUES
...
REPLACE INTO `tp_setting` (`key`, `value`) VALUES
('site_status', '1'),
('search_model', '2'),
('sitemap_model', '2'),
('changefreq', 'weekly'),
...
('copy', '老张博客 © <a class="site_url" href="http://www.phpdefault.com">phpdefault.com</a>'),
('site_name', '老张博客'),
...
('site_url', 'http://www.phpdefault.com/'),
...
('site_idea', ''),
('links', '{"1":{"id":"1","name":"\\u8001\\u5f20\\u535a\\u5ba2","link_url":"http:\\/\\/www.phpdefault.com","sort":"1"}}');
*/