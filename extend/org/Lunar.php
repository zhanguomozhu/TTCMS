...
class Lunar{ 
  ...
  * @param date 公历-日 
  */ 
  public function convertSolarToLunar($year,$month,$date){//debugger; 
 ...
 */
  public function getLunarYearMonths($year){//debugger; 
    $monthData=$this->getLunarMonths($year); 
    $res=array(); 
    $temp=0; 
    $yearData=$this->lunarInfo[$year-$this->MIN_YEAR]; 
  ...
  * @param between 天数 
  */ 
  public function getLunarByBetween($year,$between){//debugger; 
    $lunarArray=array(); 
    $yearMonth=array(); 
    $t=0; 
    $e=0; 
