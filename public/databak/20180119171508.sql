...
-- Records of tp_admin
-- ----------------------------
INSERT INTO `tp_admin` (`id`,`username`,`password`,`avatar`,`phone`,`logintime`,`loginip`,`status`,`admin`,`num`,`session_id`,`token`,`token_exptime`,`create_time`,`update_time`) VALUES ('1','admin','e10adc3949ba59abbe56e057f20f883e','uploads/images/20180115\a3bc196253623587289db899c37f5ce8.jpg','15617578175','1516350905','127.0.0.1','0','1','43','f4tsv95qnm9h5e2h30qm5mlvs5','','0','0','0');
INSERT INTO `tp_admin` (`id`,`username`,`password`,`avatar`,`phone`,`logintime`,`loginip`,`status`,`admin`,`num`,`session_id`,`token`,`token_exptime`,`create_time`,`update_time`) VALUES ('4','admin1','e00cf25ad42683b3df678c61f42c6bda','uploads/images/20180119\7790a81a78013f2cace33c48ed43df66.jpg','15617577173','1516340618','127.0.0.1','0','0','1','tobgtn1tikmvh066de3jcssii3','','0','0','0');
...
-- ----------------------------
INSERT INTO `tp_auth_group` (`id`,`title`,`status`,`rules`,`create_time`,`update_time`) VALUES ('1','超级管理员','1','1,5,22,21,20,19,18,23,4,17,16,15,14,3,13,12,11,10,2,9,8,7,6','1509167505','1509167505');
INSERT INTO `tp_auth_group` (`id`,`title`,`status`,`rules`,`create_time`,`update_time`) VALUES ('2','普通管理员','1','1,4,17,16,15,14,2,9,8,7,6','1509167505','1509167505');
...
INSERT INTO `tp_auth_rule` (`id`,`name`,`title`,`type`,`status`,`condition`,`pid`,`level`,`icon`,`sort`,`create_time`,`update_time`) VALUES ('5','conf/lst','系统设置','1','1','','1','1','fa-cog','4','0','0');
...
-- Records of tp_conf
-- ----------------------------
INSERT INTO `tp_conf` (`id`,`conf_cate_id`,`cnname`,`enname`,`type`,`value`,`values`,`sort`,`create_time`,`update_time`) VALUES ('10','2','站点名称','sitename','1','TTCMS','thinkphp5功能集成','1','1510122582','1510123095');
INSERT INTO `tp_conf` (`id`,`conf_cate_id`,`cnname`,`enname`,`type`,`value`,`values`,`sort`,`create_time`,`update_time`) VALUES ('11','2','站点描述','desc','2','TTCMS','关于thinkphp5的功能集合','2','1510122724','1510123095');
INSERT INTO `tp_conf` (`id`,`conf_cate_id`,`cnname`,`enname`,`type`,`value`,`values`,`sort`,`create_time`,`update_time`) VALUES ('13','1','是否启用验证码','code','3','否','是,否','5','1510124164','1510124503');
...
INSERT INTO `tp_conf` (`id`,`conf_cate_id`,`cnname`,`enname`,`type`,`value`,`values`,`sort`,`create_time`,`update_time`) VALUES ('17','3','喜欢的运动','like ','4','篮球,足球,橄榄球,羽毛球','篮球,足球,橄榄球,羽毛球','50','0','0');
INSERT INTO `tp_conf` (`id`,`conf_cate_id`,`cnname`,`enname`,`type`,`value`,`values`,`sort`,`create_time`,`update_time`) VALUES ('18','1','网站logo','logo','6','uploads/images/20180115\b9235e7ff36f1dc1f5f2edfc4b56cd86.jpg','','50','0','0');
