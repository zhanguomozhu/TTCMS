...
//            }
    ...
    public function getGroups($uid) {
        ...
        $user_groups = Db::view($this->config['auth_group_access'], 'admin_id,group_id')->view($this->config['auth_group'], 'title,rules', "{$this->config['auth_group_access']}.group_id={$this->config['auth_group']}.id")
                        ->where(['admin_id' => $uid, 'status' => 1])->select();
