<?php
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://' . $_SERVER['SERVER_NAME'] . '/admin/oauth/callback/type/');//因与workerman启动文件冲突，注释掉

return [
//     //支付宝登录mapi
//     'THINK_SDK_ALIPAY' => [
//         'APP_KEY' => '2017092808976662', //应用注册成功后分配的 APP ID
...
//     ],
    //新浪微博配置
    'THINK_SDK_SINA' => [
        'APP_KEY' => '2265426676', //应用注册成功后分配的 APP ID
        'APP_SECRET' => '8f3ef4b14d4bfd6a718bacffcda4b2e0', //应用注册成功后分配的KEY
